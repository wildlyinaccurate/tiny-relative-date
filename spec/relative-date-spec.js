...
describe('tiny-relative-date', () => {
  describe('Main module with default locale', () => {
    ...
    it('Returns the correct relative string for past dates', () => {
      ...
      expect(relativeDate('2017-09-07T11:59:29Z', NOW)).toEqual(
        '31 seconds ago'
      )
      expect(relativeDate('2017-09-07T11:59:01Z', NOW)).toEqual(
        '59 seconds ago'
      )
      ...
      expect(relativeDate('2017-09-07T11:58:00Z', NOW)).toEqual(
        '2 minutes ago'
      )
      expect(relativeDate('2017-09-07T11:00:01Z', NOW)).toEqual(
        '59 minutes ago'
      )
    ...
    it('Returns the correct relative string for future dates', () => {
      expect(relativeDate('2017-09-07T12:00:31Z', NOW)).toEqual(
        '31 seconds from now'
      )
      expect(relativeDate('2017-09-07T12:00:59Z', NOW)).toEqual(
        '59 seconds from now'
      )
      expect(relativeDate('2017-09-07T12:01:00Z', NOW)).toEqual(
        'a minute from now'
      )
      expect(relativeDate('2017-09-07T12:01:01Z', NOW)).toEqual(
        'a minute from now'
      )
      expect(relativeDate('2017-09-07T12:02:00Z', NOW)).toEqual(
        '2 minutes from now'
      )
      expect(relativeDate('2017-09-07T12:59:01Z', NOW)).toEqual(
        '59 minutes from now'
      )
      expect(relativeDate('2017-09-07T13:00:00Z', NOW)).toEqual(
        'an hour from now'
      )
      expect(relativeDate('2017-09-07T13:00:01Z', NOW)).toEqual(
        'an hour from now'
      )
      expect(relativeDate('2017-09-07T14:00:00Z', NOW)).toEqual(
        '2 hours from now'
      )
      expect(relativeDate('2017-09-08T11:00:01Z', NOW)).toEqual(
        '23 hours from now'
      )
      ...
      expect(relativeDate('2017-09-10T22:59:59Z', NOW)).toEqual(
        '2 days from now'
      )
      expect(relativeDate('2017-09-14', NOW)).toEqual('6 days from now')
      expect(relativeDate('2017-09-14T12:00:00Z', NOW)).toEqual(
        'a week from now'
      )
      expect(relativeDate('2017-10-05T12:00:00Z', NOW)).toEqual(
        '4 weeks from now'
      )
      expect(relativeDate('2017-10-07T12:00:00Z', NOW)).toEqual(
        'a month from now'
      )
      expect(relativeDate('2018-03-07T12:00:00Z', NOW)).toEqual(
        '6 months from now'
      )
      expect(relativeDate('2018-09-07T12:00:00Z', NOW)).toEqual(
        'a year from now'
      )
      expect(relativeDate('2019-01-07T12:00:00Z', NOW)).toEqual(
        'a year from now'
      )
      expect(relativeDate('2019-10-07T12:00:00Z', NOW)).toEqual(
  ...
  describe('Constructing with a custom translation object', () => {
    const relativeDateCustom = relativeDateFactory({
      ...
      aDayAgo: (value, seconds) => `${Math.floor(seconds / 3600)} hours ago`,
    ...
    it('Returns the correct relative string for the custom locale', () => {
      ...
      expect(relativeDateCustom('2017-09-06T12:00:01Z', NOW)).toEqual(
        '23 hours in the past'
      )
    })

    it('Supports functions as translation values', () => {
      expect(relativeDateCustom('2017-08-24T12:00:00Z', NOW)).toEqual(
        '14 days ago'
      )
      expect(relativeDateCustom('2017-09-06T12:00:00Z', NOW)).toEqual(
        '24 hours ago'
      )
    })
  })
